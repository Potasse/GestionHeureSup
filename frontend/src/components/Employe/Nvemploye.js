...
function Nvemploye() {
  ...
  const handleAddEmploye = (e) => {
      ...
      //console.log(nom, prenom, salaireB, matricule);
      e.preventDefault()

      axios.post(`http://localhost:5000/employe/create-employe`, { 'matricule': matricule, 'nom': nom, 'prenom': prenom, 'salaireB':salaireB })
        .then(res =>{
          ...
          <div className="max-w-xl mx-auto rounded-md shadow-sm">
            ...
            <div>
              <form action="" method="POST">
                ...
                <div className="mb-6">
                  <label htmlFor="salaire" className="block mb-2 text-sm text-gray-600">
                    Salaire de base
                  </label>
                  <input
                  value={ salaireB }
